...
4. **Style** must be one of: Belgian Wit, Hefeweizen, Blonde Ale, Lager, Strong Lager, Kölsch, Pale Ale, IPA, Saison, Porter, Stout, Sour, Belgian Ale. Pick the closest (a Helles or Pilsner is Lager, an APA is Pale Ale, a NEIPA or DIPA is IPA, a Gose or fruit sour is Sour, a Dubbel or Tripel is Belgian Ale, a Dunkel or Bock is Strong Lager if above 6.5% ABV else Lager).
